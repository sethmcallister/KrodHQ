package xyz.sethy.factions.managers.adaptrs;
...
/**
 * Created by Seth on 21/03/2017.
 */
public class LocationAdaptor implements JsonDeserializer<Location>, JsonSerializer<Location>
{
    @Override

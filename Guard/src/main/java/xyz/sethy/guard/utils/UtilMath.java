...
public class UtilMath
{
    ...
    public static long averageLong(List<Long> list)
    {
        long add = 0L;
        Long listlist;
        for (Iterator localIterator = list.iterator(); localIterator.hasNext(); add += listlist.longValue())
        {
            listlist = (Long) localIterator.next();
        }
    ...
    public static double averageDouble(List<Double> list)
    {
        ...
        Double listlist;
        for (Iterator localIterator = list.iterator(); localIterator.hasNext(); add = Double.valueOf(add.doubleValue() + listlist.doubleValue()))
        {
            listlist = (Double) localIterator.next();
        }

...
public class RoadProcessor extends BukkitRunnable
{
    ...
    public RoadProcessor(final Plugin plugin, final Location center, final int maxPerTick, final int delay)
    {
        this.center = center;
    ...
    private RoadProcessor(final Plugin plugin, final Location center, final int delay, final Processor procesor)
    {
        this.center = center;
    ...
    public void run()
    {
        ...
        new RoadProcessor(this.plugin, this.center, this.delay, this.processor).runTaskLater((Plugin) this.plugin, (long) this.delay);
    }
    ...
    public static class Processor
    {
        ...
        public boolean run()
        {
            ...
            SG.getInstance().setGameState(GameState.PREGAME);
            return true;
        }
        ...
        {
            final int rand = RandomUtils.nextInt(3);
            if (rand == 0)
            {
